        ...
        <Container fluid>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              <Nav.Link href="#home" className="text-link">
                Home
              </Nav.Link>
              <Nav.Link href="#link" className="text-link">
                About
              </Nav.Link>
              <Nav.Link href="#team" className="text-link">
                Team
              </Nav.Link>
              <Nav.Link href="#events" className="text-link">
                Events
              </Nav.Link>
              <Button variant="outline-dark" className="btn-link rounded-pill">
                <Nav.Link href="#form" className="btn-text-link">
                  Join Us
                </Nav.Link>
              </Button>
            </Nav>
